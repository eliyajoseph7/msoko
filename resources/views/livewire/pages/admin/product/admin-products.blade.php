            ...
            <div class="max-w-full mx-auto sm:px-6 lg:px-0">
                <div class="w-full">
                    <div class="flex justify-end pb-2">
                        ...
                        data-drawer-target="product-form-drawer" data-drawer-show="product-form-drawer" data-drawer-placement="right" aria-controls="product-form-drawer"
                                            ...
                                            @forelse ($data as $dt)
                                                <tr wire:key="{{ $dt->id }}"
                                                    ...
                                                    <td class="px-4 py-3 flex items-center justify-end space-x-1">
                                                        <button title="Update" 
                                                        wire:click="$dispatch('update_product', {'id': {{ $dt->id }}})"
                                                        data-drawer-target="product-form-drawer" data-drawer-show="product-form-drawer" data-drawer-placement="right" aria-controls="product-form-drawer"
