            ...
            <div class="max-w-full mx-auto sm:px-6 lg:px-0">
                <div class="w-full">
                    <div class="flex justify-end pb-2">
                        <button wire:click="$dispatch('openModal', {component: 'pages.admin.user.user-form'})"
                                            ...
                                            @forelse ($data as $dt)
                                                <tr wire:key="{{ $dt->id }}"
                                                    ...
                                                    <td class="px-4 py-3 flex items-center justify-end space-x-1">
                                                        <button title="Update"
                                                            wire:click="$dispatch('openModal', {component: 'pages.admin.user.user-form', arguments: {id: {{ $dt->id }}}})"
