...
<nav class="fixed top-0 z-40  w-full border-b-0 border-gray-100">
    <div class="px-3 py-5 lg:px-5 lg:pl-3 bg-[url('{{ asset('assets/images/sliders/1.jpg') }}')] bg-cover bg-center bg-blend-multiply bg-[#093B6D]">
